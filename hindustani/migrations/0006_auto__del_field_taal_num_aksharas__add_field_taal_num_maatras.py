...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Taal.num_aksharas'
        db.delete_column(u'hindustani_taal', 'num_aksharas')

        # Adding field 'Taal.num_maatras'
        db.add_column(u'hindustani_taal', 'num_maatras',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Taal.num_aksharas'
        db.add_column(u'hindustani_taal', 'num_aksharas',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'Taal.num_maatras'
        db.delete_column(u'hindustani_taal', 'num_maatras')
