...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hindustani_recording', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Recording.title'
        db.alter_column(u'hindustani_recording', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
