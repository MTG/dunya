...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'hindustani_form', 'uuid',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=36, blank=True),
                      keep_default=False)

        # Adding field 'Raag.uuid'
        db.add_column(u'hindustani_raag', 'uuid',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=36, blank=True),
                      keep_default=False)

        # Adding field 'Laya.uuid'
        db.add_column(u'hindustani_laya', 'uuid',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=36, blank=True),
                      keep_default=False)

        # Adding field 'Taal.uuid'
        db.add_column(u'hindustani_taal', 'uuid',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=36, blank=True),
                      keep_default=False)

        for f in hindustani.models.Form.objects.all():
            f.uuid = unicode(uuid.uuid4())
            f.save()

        for r in hindustani.models.Raag.objects.all():
            r.uuid = unicode(uuid.uuid4())
            r.save()

        for t in hindustani.models.Taal.objects.all():
            t.uuid = unicode(uuid.uuid4())
            t.save()

        for l in hindustani.models.Laya.objects.all():
            l.uuid = unicode(uuid.uuid4())
            l.save()


    def backwards(self, orm):
        # Deleting field 'Form.uuid'
        db.delete_column(u'hindustani_form', 'uuid')

        # Deleting field 'Raag.uuid'
        db.delete_column(u'hindustani_raag', 'uuid')

        # Deleting field 'Laya.uuid'
        db.delete_column(u'hindustani_laya', 'uuid')

        # Deleting field 'Taal.uuid'
        db.delete_column(u'hindustani_taal', 'uuid')
    ...
    models = {
        ...
        u'hindustani.release': {
            ...
            'mbid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'null': 'True', 'blank': 'True'}),
            'recordings': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['hindustani.Recording']", 'through': u"orm['hindustani.ReleaseRecording']", 'symmetrical': 'False'}),
