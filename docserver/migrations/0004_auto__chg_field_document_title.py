...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'docserver_document', 'title', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Document.title'
        db.alter_column(u'docserver_document', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))
