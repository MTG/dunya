...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PyCompmusicVersion'
        db.create_table(u'docserver_pycompmusicversion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sha1', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('commit_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'docserver', ['PyCompmusicVersion'])

        # Adding model 'Worker'
        db.create_table(u'docserver_worker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hostname', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('essentia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['docserver.EssentiaVersion'], null=True, blank=True)),
            ('pycompmusic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['docserver.PyCompmusicVersion'], null=True, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='0', max_length=1)),
        ))
        db.send_create_signal(u'docserver', ['Worker'])

        # Adding field 'DerivedFile.essentia'
        db.add_column(u'docserver_derivedfile', 'essentia',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['docserver.EssentiaVersion'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DerivedFile.pycompmusic'
        db.add_column(u'docserver_derivedfile', 'pycompmusic',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['docserver.PyCompmusicVersion'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'EssentiaVersion.commit_date'
        db.add_column(u'docserver_essentiaversion', 'commit_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PyCompmusicVersion'
        db.delete_table(u'docserver_pycompmusicversion')

        # Deleting model 'Worker'
        db.delete_table(u'docserver_worker')

        # Deleting field 'DerivedFile.essentia'
        db.delete_column(u'docserver_derivedfile', 'essentia_id')

        # Deleting field 'DerivedFile.pycompmusic'
        db.delete_column(u'docserver_derivedfile', 'pycompmusic_id')

        # Deleting field 'EssentiaVersion.commit_date'
        db.delete_column(u'docserver_essentiaversion', 'commit_date')
