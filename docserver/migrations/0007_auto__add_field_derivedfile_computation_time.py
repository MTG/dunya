...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DerivedFile.computation_time'
        db.add_column(u'docserver_derivedfile', 'computation_time',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DerivedFile.computation_time'
        db.delete_column(u'docserver_derivedfile', 'computation_time')
