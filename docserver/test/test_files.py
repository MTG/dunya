...
class SourceFileTest(TestCase):
    def setUp(self):
        ...
        self.doc1 = models.Document.objects.create(title="doc1", external_identifier="111111", collection=self.col1)
        self.doc2 = models.Document.objects.create(title="doc2", external_identifier="222222", collection=self.col2)
        self.doc3 = models.Document.objects.create(title="doc3", external_identifier="333333", collection=self.col3)
