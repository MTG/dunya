...
urlpatterns = [
    ...
    url(r'manager/create_doc_collection/(?P<slug>[^/]+)$', views.create_doc_collection, name='docserver-create-doc-collection'),
    url(r'manager/add_doc_collection/(?P<slug>[^/]+)$', views.add_doc_collection, name='docserver-add-doc-collection'),
    url(r'manager/doc_collection/(?P<rel_id>[0-9]+)$', views.doc_collection_edit, name='docserver-doc-collectionedit'),
