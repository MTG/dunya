...
onsParams = coll.namedtuple(
    "onsParams", "frmHop frmLen pdSmooth wtol pkProm thresE maxLen binWidth wtolHistAv Nbins minLen"
)
...
TCparams = coll.namedtuple(
    "TCparams", "theta BPM binWidth wtolHistAv Nbins minBPM delta octTol smoothParam octCorrectParam"
)
