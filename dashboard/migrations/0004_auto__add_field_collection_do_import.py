...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.do_import'
        db.add_column(u'dashboard_collection', 'do_import',
    ...
    def backwards(self, orm):
        # Deleting field 'Collection.do_import'
        db.delete_column(u'dashboard_collection', 'do_import')
