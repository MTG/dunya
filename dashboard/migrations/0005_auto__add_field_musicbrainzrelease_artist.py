...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MusicbrainzRelease.artist'
        db.add_column(u'dashboard_musicbrainzrelease', 'artist',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MusicbrainzRelease.artist'
        db.delete_column(u'dashboard_musicbrainzrelease', 'artist')
