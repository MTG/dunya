...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CollectionFileLogMessage.checker'
        db.alter_column(u'dashboard_collectionfilelogmessage', 'checker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.CompletenessChecker'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CollectionFileLogMessage.checker'
        raise RuntimeError("Cannot reverse this migration. 'CollectionFileLogMessage.checker' and its values cannot be restored.")
