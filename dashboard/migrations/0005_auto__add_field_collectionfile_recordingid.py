...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CollectionFile.recordingid'
        db.add_column(u'dashboard_collectionfile', 'recordingid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CollectionFile.recordingid'
        db.delete_column(u'dashboard_collectionfile', 'recordingid')
