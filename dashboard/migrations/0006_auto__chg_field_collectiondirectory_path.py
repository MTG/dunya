...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CollectionDirectory.path'
        db.alter_column(u'dashboard_collectiondirectory', 'path', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'CollectionDirectory.path'
        db.alter_column(u'dashboard_collectiondirectory', 'path', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        u'dashboard.collection': {
            ...
            'do_import': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
