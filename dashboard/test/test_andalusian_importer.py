...
class AndalusianImporterTest(TestCase):
    ...
    def test_get_orchestra_performances(self):
        data = [{'type-id': '5be4c609-9afa-4ea0-910b-12ffb71e3821',
                 'type': 'member of band',
                 'target': '02568992-bca1-4310-a7cb-4c376c7cea6e',
                 'direction': 'backward',
                 'attribute-list': ['viola'],
                 'artist': {'id': '02568992-bca1-4310-a7cb-4c376c7cea6e',
                            'name': 'احمد البردعي',
                ...
                {'type-id': '5be4c609-9afa-4ea0-910b-12ffb71e3821',
                 ...
                 'direction': 'backward',
                 'attribute-list': ['tar'],
                 'artist': {'id': '04f3585f-3f9f-4966-8e19-75da8cf73808',
                ...
                {'type-id': '5be4c609-9afa-4ea0-910b-12ffb71e3821',
                 ...
                 'artist': {'id': '1b5d9044-94e8-4866-b2c8-994305d8b5b9',
                            'name': 'محمد الخلوف',
                ...
                {'type': 'member of band',
                 ...
                 'artist': {'id': '2070a017-96e1-45aa-817a-9ecab2286ab4',
                            'name': 'أنس العطار',
                ...
                {'type-id': '5be4c609-9afa-4ea0-910b-12ffb71e3821',
                 ...
                 'artist': {'id': '20dc0a1d-9d54-4344-a6af-60e11606a89b',
                            'name': 'رضا الطنيبر',
        ...
        expected = [('02568992-bca1-4310-a7cb-4c376c7cea6e', ['viola']),
