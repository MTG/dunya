...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Makam.uuid'
        db.add_column(u'makam_makam', 'uuid',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=36, blank=True),
                      keep_default=False)

        # Adding field 'Form.uuid'
        db.add_column(u'makam_form', 'uuid',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=36, blank=True),
                      keep_default=False)

        # Adding field 'Usul.uuid'
        db.add_column(u'makam_usul', 'uuid',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=36, blank=True),
                      keep_default=False)

        for m in makam.models.Makam.objects.all():
            m.uuid = unicode(uuid.uuid4())
            m.save()

        for f in makam.models.Form.objects.all():
            f.uuid = unicode(uuid.uuid4())
            f.save()

        for u in makam.models.Usul.objects.all():
            u.uuid = unicode(uuid.uuid4())
            u.save()


    def backwards(self, orm):
        # Deleting field 'Makam.uuid'
        db.delete_column(u'makam_makam', 'uuid')

        # Deleting field 'Form.uuid'
        db.delete_column(u'makam_form', 'uuid')

        # Deleting field 'Usul.uuid'
        db.delete_column(u'makam_usul', 'uuid')
    ...
    models = {
        ...
        u'makam.instrument': {
            ...
            'name_tr': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'makam.instrumentperformance': {
            ...
            'artist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['makam.Artist']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instrument': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['makam.Instrument']", 'null': 'True', 'blank': 'True'}),
        ...
        u'makam.recording': {
            ...
            'description': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['data.Description']"}),
            'has_gazel': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_taksim': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'makam.release': {
            ...
            'mbid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'null': 'True', 'blank': 'True'}),
            'recordings': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['makam.Recording']", 'through': u"orm['makam.ReleaseRecording']", 'symmetrical': 'False'}),
