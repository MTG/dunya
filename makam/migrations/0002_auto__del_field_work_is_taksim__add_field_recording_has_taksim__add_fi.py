...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing index on 'Artist', fields ['dummy']
        db.delete_index(u'makam_artist', ['dummy'])
        ...
        # Deleting field 'Recording.has_taksim'
        db.delete_column(u'makam_recording', 'has_taksim')

        # Deleting field 'Recording.has_gazel'
        db.delete_column(u'makam_recording', 'has_gazel')

        # Removing M2M table for field makam on 'Recording'
        db.delete_table(db.shorten_name(u'makam_recording_makam'))


        # Changing field 'Recording.title'
        db.alter_column(u'makam_recording', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
