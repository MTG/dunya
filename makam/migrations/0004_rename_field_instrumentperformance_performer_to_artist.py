...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_index('makam_instrumentperformance', ['performer_id'])
        db.rename_column(u'makam_instrumentperformance', 'performer_id', 'artist_id')
        db.alter_column('makam_instrumentperformance', 'artist_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(
                            blank=True,
                            null=True,
                            to=orm['makam.Artist']
                        ))
        db.create_index('makam_instrumentperformance', ['artist_id'])

    def backwards(self, orm):
        db.delete_index('makam_instrumentperformance', ['artist_id'])
        db.rename_column(u'makam_instrumentperformance', 'artist_id', 'performer_id')
        db.alter_column('makam_instrumentperformance', 'performer_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(
                            blank=True,
                            null=True,
                            to=orm['makam.Artist']
                        ))
        db.create_index('makam_instrumentperformance', ['performer_id'])
