...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instrument.mbid'
        db.add_column(u'makam_instrument', 'mbid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Instrument.hidden'
        db.add_column(u'makam_instrument', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Instrument.name_tr'
        db.add_column(u'makam_instrument', 'name_tr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instrument.mbid'
        db.delete_column(u'makam_instrument', 'mbid')

        # Deleting field 'Instrument.hidden'
        db.delete_column(u'makam_instrument', 'hidden')

        # Deleting field 'Instrument.name_tr'
        db.delete_column(u'makam_instrument', 'name_tr')
