...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'carnatic_composeralias', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('composer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='aliases', to=orm['carnatic.Composer'])),
        ...
        db.send_create_signal(u'carnatic', ['ComposerAlias'])

        # Adding model 'ArtistAlias'
        db.create_table(u'carnatic_artistalias', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='aliases', to=orm['carnatic.Artist'])),
            ('alias', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('primary', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('locale', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal(u'carnatic', ['ArtistAlias'])


    def backwards(self, orm):
        # Deleting model 'ComposerAlias'
        db.delete_table(u'carnatic_composeralias')

        # Deleting model 'ArtistAlias'
        db.delete_table(u'carnatic_artistalias')
