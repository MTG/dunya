...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Taala.transliteration'
        db.rename_column(u'carnatic_taala', 'transliteration', 'common_name')

        # Renaming field 'Raaga.transliteration'
        db.rename_column(u'carnatic_raaga', 'transliteration', 'common_name')

    def backwards(self, orm):
        # Renaming field 'Taala.common_name'
        db.rename_column(u'carnatic_taala', 'common_name', 'transliteration')

        # Renaming field 'Raaga.common_name'
        db.rename_column(u'carnatic_raaga', 'common_name', 'transliteration')
