...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'carnatic_instrument', 'mbid')

        # Deleting field 'Instrument.hidden'
        db.delete_column(u'carnatic_instrument', 'hidden')
