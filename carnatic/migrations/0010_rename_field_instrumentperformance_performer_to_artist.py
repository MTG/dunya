...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_index('carnatic_instrumentperformance', ['performer_id'])
        db.rename_column(u'carnatic_instrumentperformance', 'performer_id', 'artist_id')
        db.alter_column('carnatic_instrumentperformance', 'artist_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(
                            blank=True,
                            null=True,
                            to=orm['carnatic.Artist']
                        ))
        db.create_index('carnatic_instrumentperformance', ['artist_id'])

    def backwards(self, orm):
        db.delete_index('carnatic_instrumentperformance', ['artist_id'])
        db.rename_column(u'carnatic_instrumentperformance', 'artist_id', 'performer_id')
        db.alter_column('carnatic_instrumentperformance', 'performer_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(
                            blank=True,
                            null=True,
                            to=orm['carnatic.Artist']
                        ))
        db.create_index('carnatic_instrumentperformance', ['performer_id'])
