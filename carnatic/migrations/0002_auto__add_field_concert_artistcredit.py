...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Concert.artistcredit'
        db.add_column(u'carnatic_concert', 'artistcredit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Concert.artistcredit'
        db.delete_column(u'carnatic_concert', 'artistcredit')
