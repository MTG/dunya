...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'carnatic_artist_group_members', (
        ...
        db.create_unique(u'carnatic_artist_group_members', ['from_artist_id', 'to_artist_id'])


    def backwards(self, orm):
        # Removing M2M table for field group_members on 'Artist'
        db.delete_table('carnatic_artist_group_members')
