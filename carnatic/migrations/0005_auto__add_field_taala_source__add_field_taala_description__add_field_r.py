...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Taala.source'
        db.add_column(u'carnatic_taala', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='taala_source_set', null=True, to=orm['data.Source']),
                      keep_default=False)

        # Adding field 'Taala.description'
        db.add_column(u'carnatic_taala', 'description',
        ...
        db.create_table(u'carnatic_taala_references', (
        ...
        db.create_unique(u'carnatic_taala_references', ['taala_id', 'source_id'])

        # Adding M2M table for field images on 'Taala'
        db.create_table(u'carnatic_taala_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('taala', models.ForeignKey(orm[u'carnatic.taala'], null=False)),
            ('image', models.ForeignKey(orm[u'data.image'], null=False))
        ))
        db.create_unique(u'carnatic_taala_images', ['taala_id', 'image_id'])

        # Adding field 'Raaga.source'
        db.add_column(u'carnatic_raaga', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='raaga_source_set', null=True, to=orm['data.Source']),
                      keep_default=False)

        # Adding field 'Raaga.description'
        db.add_column(u'carnatic_raaga', 'description',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Description'], null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field references on 'Raaga'
        db.create_table(u'carnatic_raaga_references', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('raaga', models.ForeignKey(orm[u'carnatic.raaga'], null=False)),
            ('source', models.ForeignKey(orm[u'data.source'], null=False))
        ))
        db.create_unique(u'carnatic_raaga_references', ['raaga_id', 'source_id'])

        # Adding M2M table for field images on 'Raaga'
        db.create_table(u'carnatic_raaga_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('raaga', models.ForeignKey(orm[u'carnatic.raaga'], null=False)),
            ('image', models.ForeignKey(orm[u'data.image'], null=False))
        ))
        db.create_unique(u'carnatic_raaga_images', ['raaga_id', 'image_id'])


    def backwards(self, orm):
        # Deleting field 'Taala.source'
        db.delete_column(u'carnatic_taala', 'source_id')

        # Deleting field 'Taala.description'
        db.delete_column(u'carnatic_taala', 'description_id')

        # Removing M2M table for field references on 'Taala'
        db.delete_table('carnatic_taala_references')

        # Removing M2M table for field images on 'Taala'
        db.delete_table('carnatic_taala_images')

        # Deleting field 'Raaga.source'
        db.delete_column(u'carnatic_raaga', 'source_id')

        # Deleting field 'Raaga.description'
        db.delete_column(u'carnatic_raaga', 'description_id')

        # Removing M2M table for field references on 'Raaga'
        db.delete_table('carnatic_raaga_references')

        # Removing M2M table for field images on 'Raaga'
        db.delete_table('carnatic_raaga_images')
