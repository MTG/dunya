...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstrumentPerformance.instrument'
        db.alter_column(u'carnatic_instrumentperformance', 'instrument_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carnatic.Instrument'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'InstrumentPerformance.instrument'
        db.alter_column(u'carnatic_instrumentperformance', 'instrument_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['carnatic.Instrument']))
