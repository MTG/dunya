...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'carnatic_location_images'))

        # Removing M2M table for field references on 'Location'
        db.delete_table(db.shorten_name(u'carnatic_location_references'))
        ...
        # Deleting field 'Concert.label'
        db.delete_column(u'carnatic_concert', 'label_id')

        # Deleting field 'Concert.location'
        db.delete_column(u'carnatic_concert', 'location_id')

        # Deleting field 'ConcertRecording.source'
        db.delete_column(u'carnatic_concertrecording', 'source_id')

        # Deleting field 'ConcertRecording.description'
        db.delete_column(u'carnatic_concertrecording', 'description_id')

        # Removing M2M table for field references on 'ConcertRecording'
        db.delete_table(db.shorten_name(u'carnatic_concertrecording_references'))

        # Removing M2M table for field images on 'ConcertRecording'
        db.delete_table(db.shorten_name(u'carnatic_concertrecording_images'))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'carnatic_location', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='location_source_set', null=True, to=orm['data.Source'], blank=True)),
        ))
        db.send_create_signal(u'carnatic', ['Location'])

        # Adding M2M table for field images on 'Location'
        m2m_table_name = db.shorten_name(u'carnatic_location_images')
        ...
        m2m_table_name = db.shorten_name(u'carnatic_location_references')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm[u'carnatic.location'], null=False)),
            ('source', models.ForeignKey(orm[u'data.source'], null=False))
        ))
        db.create_unique(m2m_table_name, ['location_id', 'source_id'])
        ...
        # Adding field 'Concert.label'
        db.add_column(u'carnatic_concert', 'label',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Label'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Concert.location'
        db.add_column(u'carnatic_concert', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carnatic.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConcertRecording.source'
        db.add_column(u'carnatic_concertrecording', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='concertrecording_source_set', null=True, to=orm['data.Source'], blank=True),
                      keep_default=False)

        # Adding field 'ConcertRecording.description'
        db.add_column(u'carnatic_concertrecording', 'description',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Description'], null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field references on 'ConcertRecording'
        m2m_table_name = db.shorten_name(u'carnatic_concertrecording_references')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('concertrecording', models.ForeignKey(orm[u'carnatic.concertrecording'], null=False)),
            ('source', models.ForeignKey(orm[u'data.source'], null=False))
        ))
        db.create_unique(m2m_table_name, ['concertrecording_id', 'source_id'])

        # Adding M2M table for field images on 'ConcertRecording'
        m2m_table_name = db.shorten_name(u'carnatic_concertrecording_images')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('concertrecording', models.ForeignKey(orm[u'carnatic.concertrecording'], null=False)),
            ('image', models.ForeignKey(orm[u'data.image'], null=False))
        ))
        db.create_unique(m2m_table_name, ['concertrecording_id', 'image_id'])
