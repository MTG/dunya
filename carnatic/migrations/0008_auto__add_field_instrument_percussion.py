...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instrument.percussion'
        db.add_column(u'carnatic_instrument', 'percussion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instrument.percussion'
        db.delete_column(u'carnatic_instrument', 'percussion')
