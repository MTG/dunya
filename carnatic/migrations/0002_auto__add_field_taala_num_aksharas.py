...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Taala.num_aksharas'
        db.add_column(u'carnatic_taala', 'num_aksharas',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Taala.num_aksharas'
        db.delete_column(u'carnatic_taala', 'num_aksharas')
