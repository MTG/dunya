...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Work.form'
        db.add_column(u'carnatic_work', 'form',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carnatic.Form'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Work.language'
        db.add_column(u'carnatic_work', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carnatic.Language'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Work.form'
        db.delete_column(u'carnatic_work', 'form_id')

        # Deleting field 'Work.language'
        db.delete_column(u'carnatic_work', 'language_id')
