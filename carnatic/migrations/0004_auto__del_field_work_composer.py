...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'carnatic_work', 'composer_id')

        # Adding M2M table for field composers on 'Work'
        m2m_table_name = db.shorten_name(u'carnatic_work_composers')
        ...
        m2m_table_name = db.shorten_name(u'carnatic_work_lyricists')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('work', models.ForeignKey(orm[u'carnatic.work'], null=False)),
            ('composer', models.ForeignKey(orm[u'carnatic.composer'], null=False))
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'carnatic_work', 'composer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carnatic.Composer'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field composers on 'Work'
        db.delete_table(db.shorten_name(u'carnatic_work_composers'))

        # Removing M2M table for field lyricists on 'Work'
        db.delete_table(db.shorten_name(u'carnatic_work_lyricists'))
