...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.main_instrument'
        db.add_column(u'carnatic_artist', 'main_instrument',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carnatic.Instrument'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.main_instrument'
        db.delete_column(u'carnatic_artist', 'main_instrument_id')
