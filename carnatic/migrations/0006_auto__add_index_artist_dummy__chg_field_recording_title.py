...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index(u'carnatic_artist', ['dummy'])


        # Changing field 'Recording.title'
        db.alter_column(u'carnatic_recording', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Removing index on 'Artist', fields ['dummy']
        db.delete_index(u'carnatic_artist', ['dummy'])


        # Changing field 'Recording.title'
        db.alter_column(u'carnatic_recording', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
