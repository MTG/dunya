...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Taala.transliteration'
        db.add_column(u'carnatic_taala', 'transliteration',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Raaga.transliteration'
        db.add_column(u'carnatic_raaga', 'transliteration',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Taala.transliteration'
        db.delete_column(u'carnatic_taala', 'transliteration')

        # Deleting field 'Raaga.transliteration'
        db.delete_column(u'carnatic_raaga', 'transliteration')
