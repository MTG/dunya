...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'carnatic_concertrecording', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='concertrecording_source_set', null=True, to=orm['data.Source'])),
        ...
        db.delete_table(db.shorten_name(u'carnatic_concert_tracks'))
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'carnatic_concert_tracks')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique(m2m_table_name, ['concert_id', 'recording_id'])
    ...
    models = {
        ...
        u'carnatic.concertrecording': {
            ...
            'description': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data.Description']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'concertrecording_image_set'", 'symmetrical': 'False', 'to': u"orm['data.Image']"}),
            'recording': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['carnatic.Recording']"}),
            'references': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'concertrecording_reference_set'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['data.Source']"}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'concertrecording_source_set'", 'null': 'True', 'to': u"orm['data.Source']"}),
