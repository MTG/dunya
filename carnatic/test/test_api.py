...
class ArtistTest(TestCase):
    ...
    def setUp(self):
        ...
        self.col2 = data.models.Collection.objects.create(mbid='f33f3f73', name="collection 2", permission="S") 
        self.cbootleg = models.Concert.objects.create(collection=self.col2, title="bootleg concert", mbid="cbe1ba35-8758-4a7d-9811-70bc48f41734", bootleg=True)
