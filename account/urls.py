...
urlpatterns = [
    # Change password
    path('password', auth_views.PasswordChangeView.as_view(success_url=reverse_lazy('account-user-profile'),
                                                             template_name='registration/changepw.html'),
        name='account-user-changepw'),
    # reset password
    path('reset/', auth_views.PasswordResetView.as_view(success_url=reverse_lazy('account-pwreset-done'),
                                                          template_name='registration/pwreset.html',
                                                          email_template_name='registration/pwreset_email.html'),
        name='account-pwreset'),
    path('reset/sent', auth_views.PasswordResetDoneView.as_view(template_name='registration/pwreset_sent.html'),
